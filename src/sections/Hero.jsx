...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen min-h-[800px] w-full overflow-hidden bg-[#0d1410] font-body flex items-center justify-center">
      ...
      {/* The Huge 01 */}
      <div className="absolute -right-[2%] top-[5%] opacity-[0.02] font-display font-bold select-none pointer-events-none z-0" style={{ fontSize: '40vh', lineHeight: 0.8 }}>
        01
      </div>

      {/* Main Content Wrapper */}
      <motion.div style={{ opacity: heroOpacity, y: heroY }} className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-16 h-full flex items-center">
        
        {/* LEFT COLUMN: Vertically Stacked Stats */}
        <div className="hidden lg:flex flex-col justify-center gap-12 z-30 relative w-[15%] h-full">
          {[
            { n: '3', l: 'Languages' },
            { n: '2', l: 'Degrees' },
            { n: '8.5', l: 'IELTS Score' },
        ...
        <div className="flex-1 relative z-10 h-full flex flex-col justify-center">
          ...
          <div className="relative w-full pl-[5%] lg:pl-[10%]">
            {/* "Hello, I'm" - Positioned to rest on top of Y */}
            <motion.h3 
              initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.8 }}
              className="absolute -top-[1.5rem] lg:-top-[2.5rem] left-[10%] lg:left-[13%] text-[1.8rem] lg:text-[2.5rem] font-serif-italic text-ink z-10"
            >
              Hello, I'm
            </motion.h3>
            ...
            <motion.h1 
              ...
              className="text-[10rem] lg:text-[14rem] xl:text-[17rem] font-bold tracking-tighter text-ink leading-[0.75] font-display m-0 z-10 relative"
            >
              Yehia
            </motion.h1>
            ...
            <motion.h1 
              ...
              className="text-[9.5rem] lg:text-[13.5rem] xl:text-[16.5rem] font-serif-italic tracking-tighter text-[#5c9e6a] leading-[0.7] m-0 ml-[10%] relative z-30 mt-[-3rem] lg:mt-[-5rem]"
            >
              Salem
            </motion.h1>
          </div>
          ...
          <div className="mt-8 ml-[20%] lg:ml-[45%] xl:ml-[50%] max-w-[420px] relative z-30">
